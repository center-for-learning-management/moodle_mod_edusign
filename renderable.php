...
/**
 * This file contains the definition for the renderable classes for the edusignment
 *
 * @package   mod_edusign
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class edusign_submit_for_grading_page implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class edusign_gradingmessage implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class edusign_form implements renderable {
    /** @var moodleform $form is the edit submission form */
    public $form = null;
    /** @var string $classname is the name of the class to edusign to the container */
    public $classname = '';
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class edusign_user_summary implements renderable {
...
class edusign_feedback_plugin_feedback implements renderable {
     ...
     *
     * @param edusign_feedback_plugin $plugin
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class edusign_feedback_status implements renderable {
    ...
    /** @var stdClass edusign_grade record */
    public $grade = null;
    /** @var int coursemoduleid */
    public $coursemoduleid = 0;
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class edusign_submission_status_compact extends edusign_submission_status implements renderable {
    // Compact view of the submission status. Not in a table etc.
}

/**
 * Used to output the attempt history for a particular edusignment.
 *
 * @package mod_edusign
 * @copyright 2012 Davo Smith, Synergy Learning
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class edusign_attempt_history implements renderable {
    ...
    public $feedbackplugins = array();
    /** @var int coursemoduleid - The cmid for the edusignment */
    public $coursemoduleid = 0;
...
/**
 * Used to output the attempt history chooser for a particular edusignment.
 *
 * @package mod_edusign
 * @copyright 2016 Damyon Wiese
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class edusign_attempt_history_chooser implements renderable, templatable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class edusign_plugin_header implements renderable {
    /** @var edusign_plugin $plugin */
    public $plugin = null;

    /**
     * Header for a single plugin
     *
     * @param edusign_plugin $plugin
     */
    public function __construct(edusign_plugin $plugin) {
        $this->plugin = $plugin;
    }
}
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class edusign_grading_summary implements renderable {
    /** @var int participantcount - The number of users who can submit to this edusignment */
    ...
    /** @var int duedate - The edusignment due date (if one is set) */
    public $duedate = 0;
    /** @var int cutoffdate - The edusignment cut off date (if one is set) */
    public $cutoffdate = 0;
    /** @var int coursemoduleid - The edusignment course module id */
    public $coursemoduleid = 0;
    /** @var boolean teamsubmission - Are team submissions enabled for this edusignment */
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class edusign_course_index_summary implements renderable {
    /** @var array edusignments - A list of course module info and submission counts or statuses */
    public $edusignments = array();
     ...
     * @param int $timedue - The due date for the edusignment - may be 0 if no duedate
     * @param string $submissioninfo - A string with either the number of submitted edusignments, or the
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class edusign_files implements renderable {
    /** @var context $context */
    public $context;
    /** @var string $context */
    public $dir;
