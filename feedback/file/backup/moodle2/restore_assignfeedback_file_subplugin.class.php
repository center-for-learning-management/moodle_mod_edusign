 ...
 * to restore one edusign_feedback subplugin.
 *
 * @package   edusignfeedback_file
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_edusignfeedback_file_subplugin extends restore_subplugin {
    ...
    public function process_edusignfeedback_file_grade($data) {
        ...
        $DB->insert_record('edusignfeedback_file', $data);

        $this->add_related_files('edusignfeedback_file', 'feedback_files', 'grade', null, $oldgradeid);
    }
