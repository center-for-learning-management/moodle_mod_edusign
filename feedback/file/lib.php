...
/**
 * Serves edusignment feedback and other files.
 *
...
function edusignfeedback_file_pluginfile($course,
    ...
    // Rely on mod_edusign checking permissions.
    if (!$edusign->can_view_submission($userid)) {
        return false;
    }

    $relativepath = implode('/', $args);

    $fullpath = "/{$context->id}/edusignfeedback_file/$filearea/$itemid/$relativepath";
