 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class edusignfeedback_file_upload_zip_form extends moodleform {
    /**
    ...
    public function definition() {
        ...
        $mform->addHelpButton('feedbackzip', 'feedbackzip', 'edusignfeedback_file');
        ...
        $this->add_action_buttons(true, get_string('importfeedbackfiles', 'edusignfeedback_file'));
