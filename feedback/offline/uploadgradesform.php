 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class edusignfeedback_offline_upload_grades_form extends moodleform {
    /**
    ...
    public function definition() {
        ...
        $mform->addHelpButton('gradesfile', 'gradesfile', 'edusignfeedback_offline');
        ...
        $mform->addElement('checkbox', 'ignoremodified', '', get_string('ignoremodified', 'edusignfeedback_offline'));
        $mform->addHelpButton('ignoremodified', 'ignoremodified', 'edusignfeedback_offline');
        ...
        $this->add_action_buttons(true, get_string('uploadgrades', 'edusignfeedback_offline'));
