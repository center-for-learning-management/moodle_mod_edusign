 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_edusign_base_testcase extends advanced_testcase {
    ...
    /**
     * Setup function - we will create a course and add an edusign instance to it.
     */
    ...
    /**
     * Convenience function to create a testable instance of an edusignment.
     *
    ...
    protected function create_instance($params=array()) {
        ...
        return new mod_edusign_testable_edusign($context, $cm, $this->course);
    }
...
class_alias('mod_edusign_testable_edusign', 'testable_edusign');
