...
require_once($CFG->dirroot . '/mod/edusign/feedback/comments/locallib.php');

/**
 * Unit tests for the edusignment feedback subplugins API's privacy legacy_polyfill.
 *
 * @copyright   2018 Adrian Greeve <adriangreeve.com>
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_edusignfeedback_privacy_legacy_polyfill_test extends advanced_testcase {
 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class test_edusignfeedback_legacy_polyfill_mock_wrapper {
    /**
