...
/**
 * Tests behaviour of the edusign_portfolio_caller class.
 *
 * @package mod_edusign
 * @category test
...
/**
 * Class mod_edusign_portfolio_caller_testcase
 *
 * Tests behaviour of the edusign_portfolio_caller class.
 *
 * @copyright Brendan Cox <brendan.cox@totaralearning.com>
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_edusign_portfolio_caller_testcase extends advanced_testcase {

    /**
     * Test an edusignment file is loaded for a user who submitted it.
     */
    public function test_user_submission_file_is_loaded() {
        ...
        /* @var mod_edusign_generator $edusigngenerator */
        $edusigngenerator = $this->getDataGenerator()->get_plugin_generator('mod_edusign');

        $activityrecord = $edusigngenerator->create_instance(array('course' => $course->id));
        $cm = get_coursemodule_from_instance('edusign', $activityrecord->id);
        ...
        $caller = new edusign_portfolio_caller(array('cmid' => $cm->id, 'fileid' => $file->get_id()));
    ...
    /**
     * Test an edusignment file is not loaded for a user that did not submit it.
     */
    ...
    /**
     * Test an edusignment file is loaded for a user who is part of a group that submitted it.
     */
    ...
    /**
     * Test an edusignment file is not loaded for a user who is not part of a group that submitted it.
     */
