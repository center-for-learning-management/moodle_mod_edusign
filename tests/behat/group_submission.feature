@mod @mod_edusign
Feature: Group edusignment submissions
  In order to allow students to work collaboratively on an edusignment
  As a teacher
  ...
  Scenario: Confirm that the submission status changes for each group member
    ...
    And I am on "Course 1" course homepage
    And I click on "edusignments" "link" in the "Activities" "block"
