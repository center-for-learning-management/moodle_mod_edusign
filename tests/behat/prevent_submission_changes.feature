@mod @mod_edusign
Feature: Prevent or allow edusignment submission changes
  ...
  Scenario: Preventing changes and allowing them again
    ...
    And I should see "This edusignment is not accepting submissions"
    And I log out
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Test edusignment name"
    ...
    And I am on "Course 1" course homepage
    And I follow "Test edusignment name"
    And I should not see "This edusignment is not accepting submissions"
    And I press "Edit submission"
    And I set the following fields to these values:
