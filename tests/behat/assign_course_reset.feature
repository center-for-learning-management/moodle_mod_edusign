@mod @mod_edusign
Feature: edusign reset
  In order to reuse past edusignss
  As a teacher
  ...
  Background:
    ...
    And I add a "edusignment" to section "1" and I fill the form with:
      ...
      | edusignsubmission_onlinetext_wordlimit_enabled | 1                       |
      | edusignsubmission_onlinetext_wordlimit         | 10                      |
  ...
  Scenario: Use course reset to reset blind marking edusignment.
    Given I follow "Test edusignment name"
