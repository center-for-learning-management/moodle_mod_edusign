@mod @mod_edusign
Feature: Submit edusignment without group
  As a teacher
  I should be able to prevent students submitting team edusignments as members of the default group
  ...
  Scenario: Switch between group modes
    ...
    And the following "group members" exist:
      ...
      | student3 | GC31  |
      | student3 | GC32  |
    # Student 1 can only submit edusignment in course 2.
    When I log in as "student1"
    And I am on "Course 1" course homepage
    And I follow "Allow default group"
    Then I should not see "Not a member of any group"
    And I should not see "This edusignment requires submission in groups. You are not a member of any group"
    And I should see "Nothing has been submitted for this edusignment"
    And I press "Add submission"
    And I set the following fields to these values:
      | Online text | I'm the student submission |
    And I press "Save changes"
    And I press "Submit edusignment"
    And I press "Continue"
    And I should see "Submitted for grading"
    And I am on "Course 1" course homepage
    And I follow "Require group membership"
    And I should see "Not a member of any group"
    And I should see "This edusignment requires submission in groups. You are not a member of any group"
    And I should see "Nothing has been submitted for this edusignment"
    ...
    And I should see "Submitted for grading"
    And I log out
    # Teacher should see student 1 and student 2 has submitted edusignment.
    ...
    And I should see "The edusignment requires submission in groups. You are a member of more than one group."
    And I should see "Nothing has been submitted for this edusignment"
    And I should not see "Add submission"
    And I log out
    And I log in as "teacher1"
