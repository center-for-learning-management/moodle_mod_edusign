 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_edusign_search_testcase extends advanced_testcase {

    /**
     * Test for edusign file attachments.
     *
     * @return void
     */
    public function test_attach_files() {
        ...
        $edusignareaid = \core_search\manager::generate_areaid('mod_edusign', 'activity');
        ...
        $edusign = $this->getDataGenerator()->create_module('edusign', $record);
        ...
        $fs->create_file_from_string($filerecord, 'Test edusign file 5');

        // Returns the instance as long as the area is supported.
        $searcharea = \core_search\manager::get_search_area($edusignareaid);
        $this->assertInstanceOf('\mod_edusign\search\activity', $searcharea);
        ...
        foreach ($recordset as $record) {
            ...
            // edusign should return all files attached.
