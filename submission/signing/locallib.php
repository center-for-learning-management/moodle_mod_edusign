...
class edusign_submission_signing extends edusign_submission_plugin {
    ...
    public function get_form_elements($submission, MoodleQuickForm $mform, stdClass $data) {
        ...
        $mform->addElement(
            'html',
            "<div class='form-group row'><div class='col-md-3'>Unterschrift</div><div class='col-md-9'><canvas id='canvas' class='form-control' style='height:250px !important; touch-action:none' height='250px' width='1000px' ></canvas>
