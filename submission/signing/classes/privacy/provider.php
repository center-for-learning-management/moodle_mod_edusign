...
namespace edusignsubmission_signing\privacy;
...
class provider implements
    ...
    public static function export_submission_user_data(edusign_plugin_request_data $exportdata) {
        ...
        $plugin = $edusign->get_plugin_by_type('edusignsubmission', 'signing');
        $submission = $exportdata->get_pluginobject();
        $editortext = $plugin->get_editor_text('signing', $submission->id);
