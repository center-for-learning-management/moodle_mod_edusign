...
/**
 * Unit tests for edusignsubmission_signing.
 *
...
/**
 * Unit tests for mod/edusign/submission/signing/classes/privacy/
 *
 * @copyright  2018 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class edusignsubmission_online_privacy_testcase extends \mod_edusign\tests\mod_edusign_privacy_testcase {
    ...
    public function test_get_metadata() {
        $collection = new \core_privacy\local\metadata\collection('edusignsubmission_signing');
        $collection = \edusignsubmission_signing\privacy\provider::get_metadata($collection);
    ...
    public function test_export_submission_user_data() {
        ...
        \edusignsubmission_signing\privacy\provider::export_submission_user_data($exportdata);
        $this->assertEquals($submissiontext, $writer->get_data(['Attempt 1',
                get_string('privacy:path', 'edusignsubmission_signing')])->text);
    }
    ...
    public function test_delete_submission_for_context() {
        ...
        \edusignsubmission_signing\privacy\provider::delete_submission_for_context($requestdata);
    ...
    public function test_delete_submission_for_userid() {
        ...
        \edusignsubmission_signing\privacy\provider::delete_submission_for_userid($requestdata);
    ...
    public function test_delete_submissions() {
        ...
        $data = $DB->get_records('edusignsubmission_signing', ['edusignment' => $edusign1->get_instance()->id]);
        ...
        \edusignsubmission_signing\privacy\provider::delete_submissions($requestdata);
        ...
        $data = $DB->get_records('edusignsubmission_signing', ['edusignment' => $edusign2->get_instance()->id]);
