...
/**
 * Displays information about all the edusignment modules in the requested course
 *
 * @package   mod_edusign
...
$edusign = new edusign($context, null, $course);

// Get the edusign to render the page.
echo $edusign->view('viewcourseindex');
