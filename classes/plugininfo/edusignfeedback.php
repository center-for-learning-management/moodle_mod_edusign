...
/**
 * edusign feedback subplugin info class.
 *
 * @package   mod_edusign
...
class edusignfeedback extends base {
    ...
    public static function get_enabled_plugins() {
        ...
        $plugins = core_plugin_manager::instance()->get_installed_plugins('edusignfeedback');
        if (!$plugins) {
            return array();
        }
        $installed = array();
    ...
    public static function get_manage_url() {
        return new moodle_url('/mod/edusign/adminmanageplugins.php', array('subtype'=>'edusignfeedback'));
    }
    ...
    public function uninstall_cleanup() {
        ...
        $DB->delete_records('edusign_plugin_config', array('plugin'=>$this->name, 'subtype'=>'edusignfeedback'));
    ...
    public function load_settings(\part_of_admin_tree $adminroot, $parentnodename, $hassiteconfig) {
        ...
        if ($adminroot->fulltree) {
            $shortsubtype = substr($this->type, strlen('edusign'));
