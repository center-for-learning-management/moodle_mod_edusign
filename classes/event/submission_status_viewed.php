...
/**
 * The mod_edusign submission status viewed event.
 *
 * @package    mod_edusign
...
/**
 * The mod_edusign submission status viewed event class.
 *
...
class submission_status_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionstatusviewed', 'mod_edusign');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has viewed the submission status page for the edusignment with " .
    ...
    protected function get_legacy_logdata() {
        $this->set_legacy_logdata('view', get_string('viewownsubmissionstatus', 'edusign'));
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call submission_status_viewed::create() directly, use submission_status_viewed::create_from_edusign() instead.');
        }
