...
/**
 * The mod_edusign submission status updated event.
 *
 * @package    mod_edusign
...
/**
 * The mod_edusign submission status updated event class.
 *
...
class submission_status_updated extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionstatusupdated', 'mod_edusign');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('reverttodraftforstudent', 'edusign', array('id' => $user->id, 'fullname' => fullname($user)));
