...
/**
 * The mod_edusign submission locked event.
 *
 * @package    mod_edusign
...
/**
 * The mod_edusign submission locked event class.
 *
 * @package    mod_edusign
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_locked extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionlocked', 'mod_edusign');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('locksubmissionforstudent', 'edusign', array('id' => $user->id, 'fullname' => fullname($user)));
