...
/**
 * The mod_edusign all submissions downloaded event.
 *
 * @package    mod_edusign
...
/**
 * The mod_edusign all submissions downloaded event class.
 *
 * @package    mod_edusign
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class all_submissions_downloaded extends base {
    ...
    public static function get_name() {
        return get_string('eventallsubmissionsdownloaded', 'mod_edusign');
    }
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call all_submissions_downloaded::create() directly, use all_submissions_downloaded::create_from_edusign() instead.');
        }
