...
/**
 * The mod_edusign extension granted event.
 *
 * @package    mod_edusign
...
/**
 * The mod_edusign extension granted event class.
 *
 * @package    mod_edusign
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class extension_granted extends base {
    ...
    public static function get_name() {
        return get_string('eventextensiongranted', 'mod_edusign');
    }
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call extension_granted::create() directly, use extension_granted::create_from_edusign() instead.');
        }
