...
/**
 * The mod_edusign submission form viewed event.
 *
 * @package    mod_edusign
...
/**
 * The mod_edusign submission form viewed event class.
 *
...
class submission_confirmation_form_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionconfirmationformviewed', 'mod_edusign');
    }
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewownsubmissionform', 'edusign');
        $this->set_legacy_logdata('view confirm submit edusignment form', $logmessage);
