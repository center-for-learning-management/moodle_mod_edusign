...
/**
 * The mod_edusign submission_created abstract event.
 *
 * @package    mod_edusign
...
/**
 * The mod_edusign submission_created abstract event class.
 *
...
abstract class submission_created extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissioncreated', 'mod_edusign');
    }
