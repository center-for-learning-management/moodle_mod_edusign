...
/**
 * The mod_edusign edusignment batch set workflow stated viewed event.
 *
 * @package    mod_edusign
...
class batch_set_workflow_state_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventbatchsetworkflowstateviewed', 'mod_edusign');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the batch set workflow for the edusignment with course " .
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewbatchsetmarkingworkflowstate', 'edusign');
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call batch_set_workflow_state_viewed::create() directly, use batch_set_workflow_state_viewed::create_from_edusign() instead.');
        }
