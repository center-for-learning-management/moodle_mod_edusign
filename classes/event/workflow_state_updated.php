...
/**
 * mod_edusign workflow state updated event.
 *
 * @package    mod_edusign
...
/**
 * mod_edusign workflow state updated event class.
 *
...
class workflow_state_updated extends base {
    ...
    public static function get_name() {
        return get_string('eventworkflowstateupdated', 'mod_edusign');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('setmarkingworkflowstateforlog', 'edusign', $a);
