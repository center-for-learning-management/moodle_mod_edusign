...
/**
 * This file contains the edusignsubmission_user_provider interface.
 *
 * edusignment Sub plugins should implement this if they store personal information and can retrieve a userid.
 *
 * @package mod_edusign
