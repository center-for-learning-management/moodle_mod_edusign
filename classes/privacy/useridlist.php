...
/**
 * This file contains the mod_edusign useridlist
 *
...
class useridlist {
    ...
    /** @var int The ID of the edusignment object. */
    protected $edusignid;
     ...
     */
    public function __construct($teacherid, $edusignid) {
        $this->teacherid = $teacherid;
        $this->edusignid = $edusignid;
    }
