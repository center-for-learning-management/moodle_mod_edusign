...
/**
 * This file contains the mod_edusign edusign_plugin_request_data class
 *
 * For edusign plugin privacy data to fulfill requests.
 *
 * @package mod_edusign
...
/**
 * An object for fulfilling an edusign plugin data request.
 *
 * @copyright  2018 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class edusign_plugin_request_data {
    ...
    /** @var edusign The edusign object */
    protected $edusign;

    /**
     * Object creator for edusign plugin request data.
     *
     ...
     * Getter for this attribute.
     *
     * @return object The edusign plugin object
     */
     ...
     * Getter for this attribute.
     *
     * @return edusign The edusign object.
     */
    ...
    /**
     * A method to conveniently fetch the edusign id.
     *
     * @return int The edusign id.
     */
    public function get_edusignid() {
        return $this->edusign->get_instance()->id;
    }
