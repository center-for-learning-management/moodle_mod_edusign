 ...
 *
 * @module     mod_edusign/grading_navigation_user_info
 * @package    mod_edusign
 * @class      UserInfo
    ...
    UserInfo.prototype._refreshUserInfo = function (event, userid) {
        ...
        templates.render('mod_edusign/loading', {}).done(function (html, js) {
            ...
            if (typeof this._userCache[userid] !== "undefined") {
                ...
                var edusignmentId = this._getedusignmentId();
                var requests = ajax.call([{
                    methodname: 'mod_edusign_get_participant',
                    args: {
                        userid: userid,
                        edusignid: edusignmentId,
                        embeduser: true
                    }
                }]);
