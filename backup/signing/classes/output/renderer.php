...
namespace edusignsubmission_signing\output;
...
class renderer extends \plugin_renderer_base {
    ...
    public function fetch_delete_submission() {
        ...
        $ds = \html_writer::tag('button',
                ...
                array('type' => 'button', 'id' => constants::M_COMPONENT . '_deletesubmissionbutton',
                        'class' => constants::M_COMPONENT . '_deletesubmissionbutton btn btn-secondary'));
