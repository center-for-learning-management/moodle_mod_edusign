 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_edusignsubmission_onlinetext_subplugin extends restore_subplugin {
    ...
    /**
     * Processes one edusignsubmission_onlinetext element
     *
     * @param mixed $data
     */
    public function process_edusignsubmission_onlinetext_submission($data) {
        global $DB;
        ...
        $DB->insert_record('edusignsubmission_onlinetext', $data);

        $this->add_related_files('edusignsubmission_onlinetext', 'submissions_onlinetext', 'submission', null, $oldsubmissionid);
    }
