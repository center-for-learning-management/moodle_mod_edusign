...
require_once($CFG->dirroot . '/mod/edusign/backup/moodle2/restore_edusign_stepslib.php');

/**
 * edusign restore task that provides all the settings and steps to perform one complete restore of the activity
 *
 * @package   mod_edusign
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class restore_edusign_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        // edusignment only has one structure step.
        $this->add_step(new restore_edusign_activity_structure_step('edusign_structure', 'edusign.xml'));
    }
     ...
     * edusign logs. It must return one array
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('edusign', 'view', 'view.php?id={course_module}', '{edusign}');
