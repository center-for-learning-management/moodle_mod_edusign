YUI.add('moodle-mod_edusign-history', function (Y, NAME) {

// Define a function that will run in the context of a
// Node instance:
    var CSS = {
            LINK: 'mod-edusign-history-link',
            OPEN: 'mod-edusign-history-link-open',
            CLOSED: 'mod-edusign-history-link-closed',
